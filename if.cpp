...
{
    if (a % 2 == 0) {
        std::cout << "×åòíîå " << std::endl;
    }
    if (a % 2 != 0) {
        std::cout << "Íå÷åòíîå " << std::endl;
    }
    if (a < 0) {
        std::cout << "Îòðèöàòåëüíîå " << std::endl;
    }
}
void if30(int a)
{
...
int main()
{
    ...
    //std::cout << if4(2,4) << std::endl;
    //if5(-1, -2, -3);
    //std::cout << if6(2,4) << std::endl;
